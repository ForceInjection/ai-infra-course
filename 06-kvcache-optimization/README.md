...
| [KV Cache Offloading](visuals/kv-cache-offloading.html)             | preempt 驱动的 GPU↔CPU swap (基于 nano-vllm 真实实现) | 讲解 Offloading 时打开：HBM 满 → preempt → can_swap_out? → swap 到 CPU 或 recompute |
